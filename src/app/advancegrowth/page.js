    ...
    return (
        <>
            <HeroComponents
                ...
                content={
                    <div>
                        <h1 className="text-[#CEFA05] text-6xl lg:text-9xl font-bold space-y-4 py-4 uppercase px-10">Advanced Growth</h1>
                        <div className='flex gap-4 lg:gap-20 items-center justify-center px-10'>
                            <h1 className={`${londrina.className} text-[#CEFA05] text-7xl lg:text-9xl font-bold uppercase`}>System</h1>
                            <div className='w-full h-28 bg-[#CEFA05] -skew-x-6'></div>
                        </div>
