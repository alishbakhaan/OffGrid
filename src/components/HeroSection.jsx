...
const HeroSection = () => {
  return (
    <div className="relative grid content-center bg-cover bg-center bg-no-repeat w-full h-screen -z-10" style={{ backgroundImage: `url(/herobg.svg)` }}>
      {/* overlay effect */}
      <div className='absolute bg-black bg-opacity-80 top-0 right-0 left-0 bottom-0 -z-20'></div>

      {/* text content */}
      <div className="z-50 max-w-3xl m-auto">
        <div className="flex justify-center gap-5 sm:gap-12 items-center">
          ...
          <div>
            <h1 className="text-[#CEFA05] md:text-7xl xl:text-9xl text-5xl font-bold space-y-4 py-8 uppercase">Growth PARTNER</h1>
          </div>
        </div>
        <p className={`${lato.className} text-white text-sm md:text-lg text-center py-4`}>Whether you’re a custom home builder, run a construction business or provide a general trade service such as installing solar panels...</p>
