    ...
    return (
        <div>
            <div className="slanted-div after:bg-[#CEFA05]" >
                {/* overlay effect */}
                <div className='absolute object-cover w-full opacity-5 overflow-hidden bg-no-repeat bg-cover -top-20 xl:-top-60 right-0 left-0 bottom-0' style={{ backgroundImage: `url(/aboutbg.svg)` }}></div>
